...
<div class="max-w-7xl mx-auto">
    ...
    <div class="mb-8 flex items-center justify-between">
        ...
        <a href="{{ route('admin.links.index') }}" class="hidden sm:flex bg-pink-300 hover:bg-pink-200 text-slate-900 font-black py-2.5 px-5 rounded-xl border-4 border-slate-900 shadow-[4px_4px_0px_0px_#0f172a] hover:translate-x-1 hover:translate-y-1 hover:shadow-none transition-all items-center gap-2">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <!-- Card: Total Tautan -->
        <div class="bg-pink-200 border-4 border-slate-900 rounded-3xl p-6 shadow-[6px_6px_0px_0px_#0f172a] relative overflow-hidden group hover:-translate-y-1 transition-transform">
        ...
        <!-- Card: Total Klik -->
        <div class="bg-fuchsia-200 border-4 border-slate-900 rounded-3xl p-6 shadow-[6px_6px_0px_0px_#0f172a] relative overflow-hidden group hover:-translate-y-1 transition-transform">
            <i data-lucide="mouse-pointer-click" class="w-20 h-20 text-fuchsia-300 absolute -bottom-4 -right-4 stroke-[3] group-hover:scale-110 transition-transform"></i>
        ...
        <!-- Card: Top Link -->
        <div class="bg-rose-200 border-4 border-slate-900 rounded-3xl p-6 shadow-[6px_6px_0px_0px_#0f172a] relative overflow-hidden group hover:-translate-y-1 transition-transform">
            <i data-lucide="trophy" class="w-20 h-20 text-rose-300 absolute -bottom-4 -right-4 stroke-[3] group-hover:scale-110 transition-transform"></i>
            ...
            @if($topLink)
                ...
                <p class="text-sm font-bold text-rose-900 bg-rose-300 inline-block px-3 py-1 rounded-md border-2 border-slate-900 relative z-10">{{ $topLink->clicks }} Klik</p>
            @else
...
<script>
    ...
    // Palet Warna Neo-Brutalism Tema Pastel Fashion (Pink, Fuchsia, Rose, Kuning, Ungu)
    const bgColors = ['#fbcfe8', '#f5d0fe', '#fecdd3', '#fde68a', '#e9d5ff'];
